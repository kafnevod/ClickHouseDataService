...
- увеличивается место занимамое таблицей на диске за счет хранения битовой маски NULL
- увеличиватся вп\ремя обработки запросов 
...
В этом слечае при запросах выражения типа:
